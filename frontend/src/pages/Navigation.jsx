...
const Navigation = () => {
  ...
  const logoutHandler = async(e) => {
    e.preventDefault();
    axios.post(`${server}/user/logout`,null,{withCredentials:true})
    .then((res)=>{
  ...
  return (
    <div className="fixed top-[-1rem] left-[45rem] transform translate-x-1/2 translate-y-1/2 z-50 bg-[#0f0f0f] border w-[30%] px-[4rem] mb-[2rem] rounded">
      <section className="flex justify-between items-center">
        ...
        <div className="flex justify-center items-center mb-[2rem]">
          ...
          <Link to="/movies" className="flex items-center transition-transform transform hover:translate-x-2 ml-[1rem]">
            <MdOutlineLocalMovies className="mr-2 mt-[3rem]" size={26} style={{color: "white"}} />
          ...
          {!user && (
            <ul className="flex">
              <li>
                ...
                >
                  <AiOutlineLogin className="mr-2 mt-[4px]" size={26} style={{color: "white"}}/>
              ...
              <li>
                ...
                >
                  <AiOutlineUserAdd className="mr-2 mt-[4px]" size={26} style={{color: "white"}}/>
